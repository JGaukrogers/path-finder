...
INIT_POINT = test_graph_parser.nodeId_to_nodes_dict[TEST_INIT_POINT_ID]
END_POINT_SHORT = test_graph_parser.nodeId_to_nodes_dict[TEST_END_POINT_SHORT_ID]
END_POINT_LONG = test_graph_parser.nodeId_to_nodes_dict[TEST_END_POINT_LONG_ID]
...
def test_create_graph_one_edge(map_displayer):
    map_displayer.get_quietest_way(TEST_INIT_POINT_ID, TEST_END_POINT_SHORT_ID, INDEX_SHORT_HTML)


def test_create_graph_four_edges(map_displayer):
    map_displayer.get_quietest_way(TEST_INIT_POINT_ID, TEST_END_POINT_LONG_ID, INDEX_LONG_HTML)
