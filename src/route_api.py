...
@app.route('/display_downloaded_data/<init_point_lat>/<init_point_lon>/<end_point_lat>/<end_point_lon>/<path_way_priority>')
def display_downloaded_data(init_point_lat, init_point_lon, end_point_lat, end_point_lon, path_way_priority):
    ...
    if is_graph_downloaded:
        ...
        displayer.display_downloaded_data([init_point_lat, init_point_lon], out_file=HTML_OUTPATH.format(file_name='test.html'))

        return render_template(HTML_OUTFILE.format(file_name='test.html'))
