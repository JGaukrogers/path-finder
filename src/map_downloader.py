...
class DataDownloader:
    ...
    def __init__(self, area_boundaries, ophois=constants.DEFAULT_OPHOIS):
        self.city = 'test_city'
        self.area_boundaries = area_boundaries
        self.ophois = ophois
        self.osm_file = constants.OSM_FILENAME_TEMPLATE.format(area_name=self.city)
        self.extracted_graph = constants.EXTRACTED_GRAPH_FILENAME_TEMPLATE.format(area_name=self.city)
        self.simplified_graph = constants.SIMPLE_GRAPH_FILENAME_TEMPLATE.format(area_name=self.city)
